...
<script id="payment" type="text/template">
    ...
    <div class="modal-body text-center">
        ...
        {if $system['paypal_enabled']}
            ...
            <button class="js_payment-paypal btn btn-payment btn-lg mr10 mb10" 
            ...
            data-loading-text="<i class='fas fa-circle-notch fa-spin'></i> {__("Loading")}">

                <i class="fab fa-paypal fa-lg fa-fw" style="color: #00186A;"></i> {__("Paypal")}
        ...
        {if $system['creditcard_enabled']}
            ...
            <button class="js_payment-stripe btn btn-payment btn-lg mr10 mb10" 
            ...
            data-loading-text="<i class='fas fa-circle-notch fa-spin'></i> {__("Loading")}" data-method="credit"> 

                <i class="fa fa-credit-card fa-lg fa-fw" style="color: #8798CC;"></i> {__("Credit Card")}
        ...
        {if $system['alipay_enabled']}
            ...
            <button class="js_payment-stripe btn btn-payment btn-lg" 
            ...
            data-loading-text="<i class='fas fa-circle-notch fa-spin'></i> {__("Loading")}" data-method="alipay">

                <i class="fab fa-alipay fa-lg fa-fw" style="color: #5B9EDD;"></i> {__("Alipay")}
...
{if !$user->_logged_in}
    ...
    <script id="two-factor-authentication" type="text/template">
        ...
        <div class="modal-header">
            ...
            <h5 class="modal-title">{__("Two-factor authentication required")}</h5>
...
{else}
    ...
    <script id="keyboard-shortcuts" type="text/template">
        ...
        <div class="modal-header">
            ...
            <h5 class="modal-title"><i class="fa fa-keyboard mr5"></i>{__("Keyboard Shortcuts")}</h5>
        ...
        <div class="emoji-menu">
            ...
            <ul class="nav nav-tabs">
                ...
                <li class="active">
                    ...
                    <a href="#tab-emojis-{literal}{{id}}{/literal}" data-toggle="tab">
                ...
                <li>
                    ...
                    <a href="#tab-stickers-{literal}{{id}}{/literal}" data-toggle="tab">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-addon hidden-xs">{$system['system_url']}/groups/</span>
...
{if $page == "mytrips"}
        <script id="create-trip" type="text/template">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h5 class="modal-title">{__("Create New Trip")}</h5>
            </div>
            <form class="js_ajax-forms" data-url="pages_groups_events/create.php?type=event&do=create">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="title">{__("Name Your Trip")}</label>
                        <input type="text" class="form-control" name="title" id="title">
                    </div>
                    <div class="form-group">
                        <label for="location">{__("Location")}</label>
                    ...
                    <div class="form-group">
                        <label for="privacy">{__("Select Privacy")}</label>
                        <select class="form-control selectpicker" name="privacy">
                            <option value="public" data-content="<div class='option'><div class='icon'><i class='fa fa-globe fa-2x'></i></div><div class='text'><b>{__("Public Trip")}</b><br>{__("Anyone can see the event, its users and posts")}.
                            </div></div>">{__("Public Trip")}</option>
                            <option value="closed" data-content="<div class='option'><div class='icon'><i class='fa fa-unlock-alt fa-2x'></i></div><div class='text'><b>{__("Closed Trip")}</b><br>{__("Only event users can see posts")}.
                            </div></div>">{__("Closed Trip")}</option>
                            <option value="secret" data-content="<div class='option'><div class='icon'><i class='fa fa-lock fa-2x'></i></div><div class='text'><b>{__("Secret Trip")}</b><br>{__("Only invited users and event users can find the event")}.
                            </div></div>">{__("Secret Trip")}</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="category">{__("Category")}</label>
    ...
    {if $page == "ads"}
        ...
        <script id="wallet-withdraw-points" type="text/template">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title"><i class="fa fa-piggy-bank mr5"></i>{__("Withdraw Points Credit")}</h5>
            ...
            <form class="js_ajax-forms" data-url="ads/wallet.php?do=wallet_withdraw_points">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <label for="amount">{__("Your Points Credit")}</label>
    ...
    {if $page == "admin"}
        ...
        <script id="verification-documents" type="text/template">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title"><i class="fa fa-paperclip mr5"></i>{__("Verification Documents")}</h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="panel-sub-title mb10">
                                        ...
                                        <i class="fas fa-camera-retro mr10"></i>{__("Personal Photo")}

                                    </div>

                                    <a target="_blank" href="{literal}{{photo}}{/literal}">

                                        <img class="img-responsive" src="{literal}{{photo}}{/literal}">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <a target="_blank" href="{literal}{{passport}}{/literal}">
                                        ...
                                        <img class="img-responsive" src="{literal}{{passport}}{/literal}">
