        ...
        <div class="panel-body">
            ...
            <div class="mb20">
                ...
                <form class="form-inline" action="{$system['system_url']}/admincp/users/find" method="get">
                    ...
                    <button type="submit" class="btn btn-primary"><i class="fas fa-search mr5"></i>{__("Search")}</button>
        ...
        <div class="panel-body">
            ...
            <ul class="nav nav-tabs mb20">
                ...
                <li>
                    ...
                    <a href="#security" data-toggle="tab">
                        ...
                        <i class="fas fa-shield-alt fa-fw mr5"></i><strong class="pr5">{__("Security")}</strong>
                ...
                {if $system['ads_enabled'] || $system['points_enabled']}
                    ...
                    <li>
                        ...
                        <a href="#extra" data-toggle="tab">
                            ...
                            <i class="fa fa-cubes fa-fw mr5"></i><strong class="pr5">{__("Extra")}</strong>
            ...
            <div class="tab-content">
                            ...
                            <div class="col-sm-9 col-sm-offset-3">
                                ...
                                {if $data['user_subscribed']}
                                    ...
                                    <button type="button" class="btn btn-danger js_admin-deleter" data-handle="user_package" data-id="{$data['user_id']}">
                                        ...
                                        <i class="fas fa-trash-alt"></i> {__("Remove Package")}
                ...
                <div class="tab-pane" id="extra">
                    ...
                    <form class="js_ajax-forms form-horizontal" data-url="admin/users.php?id={$data['user_id']}&do=edit_points">
