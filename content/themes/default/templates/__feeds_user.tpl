        ...
        <div class="data-content">
            <div class="pull-right flip">
                ...
                {elseif $_connection == "page_manage"}
                    <div class="btn btn-danger js_page-member-remove" data-id="{$_user['node_id']}" data-uid="{$_user['user_id']}"><i class="fa fa-trash mr5"></i>{__("Remove")}</div>
                    {if $_user['i_admin']}
                        <div class="btn btn-default js_page-admin-remove" data-id="{$_user['node_id']}" data-uid="{$_user['user_id']}"><i class="fa fa-trash mr5"></i>{__("Remove Admin")}</div>
                    {else}
                        <div class="btn btn-primary btn-delete js_page-admin-addation" data-id="{$_user['node_id']}" data-uid="{$_user['user_id']}"><i class="fa fa-check mr5"></i>{__("Make Admin")}</div>
                    {/if}
                ...
                {elseif $_connection == "group_manage"}
                    <div class="btn btn-danger js_group-member-remove" data-id="{$_user['node_id']}" data-uid="{$_user['user_id']}"><i class="fa fa-trash mr5"></i>{__("Remove")}</div>
                    {if $_user['i_admin']}
                        <div class="btn btn-default js_group-admin-remove" data-id="{$_user['node_id']}" data-uid="{$_user['user_id']}"><i class="fa fa-trash mr5"></i>{__("Remove Admin")}</div>
                    {else}
                        <div class="btn btn-primary btn-delete js_group-admin-addation" data-id="{$_user['node_id']}" data-uid="{$_user['user_id']}"><i class="fa fa-check mr5"></i>{__("Make Admin")}</div>
                    {/if}
