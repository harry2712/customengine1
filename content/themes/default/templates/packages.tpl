                    ...
                    <div class="col-md-{if $packages_count >= 4}3{elseif $packages_count == 3}4{elseif $packages_count <= 2}6{/if} text-center">
                        <div class="panel panel-default panel-pricing">
                            ...
                            <div class="panel-footer">
                                {if $user->_logged_in}
                                    <button class="btn btn-lg btn-block btn-info" data-toggle="modal" data-url="#payment" data-options='{literal}{{/literal}"handle": "packages", "id": {$package["package_id"]}, "price": "{$package["price"]}", "name": "{$package["name"]}", "img": "{$package["icon"]}"{literal}}{/literal}'>
