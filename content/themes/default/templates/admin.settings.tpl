            ...
            <form class="js_ajax-forms form-horizontal" data-url="admin/settings.php?edit=posts">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <span class="help-block">
                            {__("Turn the gif posts On and Off")}
                        </span>
                    </div>
                </div>
                    ...
                    <form class="js_ajax-forms form-horizontal" data-url="admin/settings.php?edit=registration">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <span class="help-block">
                                    {__("Enable two-factor authentication to log in with a code from your email/phone as well as a password")}
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="radio radio-primary radio-inline">
                                    <input type="radio" name="two_factor_type" id="two_factor_email" value="email" {if $system['two_factor_type'] == "email"}checked{/if}>
                                    <label for="two_factor_email">{__("Email")}</label>
                                </div>
                                <div class="radio radio-primary radio-inline">
                                    <input type="radio" name="two_factor_type" id="two_factor_sms" value="sms" {if $system['two_factor_type'] == "sms"}checked{/if}>
                                    <label for="two_factor_sms">{__("SMS")}</label>
                                </div>
                                <div class="radio radio-primary radio-inline">
                                    <input type="radio" name="two_factor_type" id="two_factor_google" value="google" {if $system['two_factor_type'] == "google"}checked{/if}>
                                    <label for="two_factor_google">{__("Google Authenticator")}</label>
                                </div>
                                <span class="help-block">
