                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        {if $system['points_enabled'] || $system['ads_enabled']}
                                            {if $system['points_enabled']}
                                                <li>
                                                    <a href="{$system['system_url']}/settings/points">{__("Points")}: {$user->_data['user_points']}</a>
                                                </li>
                                            {/if}
                                            {if $system['ads_enabled']}
                                                <li>
                                                    <a href="{$system['system_url']}/wallet">{__("Wallet")}: {$system['system_currency_symbol']}{$user->_data['user_wallet_balance']|number_format:2}</a>
                                                </li>
                                            {/if}
                                            <li class="divider"></li>
                                        {/if}
