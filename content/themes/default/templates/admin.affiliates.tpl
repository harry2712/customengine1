                ...
                <table class="table table-striped table-bordered table-hover js_dataTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button data-toggle="tooltip" data-placement="top" title='{__("Mark as Paid")}' class="btn btn-xs btn-success js_admin-withdraw" data-type="affiliates" data-handle="approve" data-id="{$row['payment_id']}">
                                        <i class="fa fa-check"></i>
                                </button>
                                <button data-toggle="tooltip" data-placement="top" title='{__("Decline")}' class="btn btn-xs btn-danger js_admin-withdraw" data-type="affiliates" data-handle="decline" data-id="{$row['payment_id']}">
