                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <select class="form-control selectpicker" name="privacy">
                                    ...
                                    <option {if $data['event_privacy'] == "closed"}selected{/if} value="closed" data-content="<div class='option'><div class='icon'><i class='fas fa-unlock-alt fa-2x'></i></div><div class='text'><b>{__("Closed Event")}</b><br>{__("Only event users can see posts")}.
