                ...
                <ul class="dropdown-menu post-dropdown-menu">
                    ...
                    {if $_post['manage_post']}
                        ...
                        {if $_post['post_type'] == "product"}
                            <li>
                                <a href="" data-toggle="modal" data-url="posts/product.php?do=edit&post_id={$_post['post_id']}">
                                    <div class="action no-desc">
    ...
    <div class="post-product-wrapper mt10">
        <div class="post-product-details">
            ...
            <div class="description">
                {$_post['product']['status']|capitalize}
            </div>
        </div>
        <div class="post-product-details">
            <div class="title">
            ...
            <div class="description">
                {if $_post['product']['price'] > 0}
                    {$system['system_currency_symbol']}{$_post['product']['price']|number_format:2:",":"."} ({$system['system_currency']})
                {else}
                    {__("Free")}
                {/if}
            </div>
