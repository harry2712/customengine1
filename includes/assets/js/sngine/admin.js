...
$(function() {
    ...
    $('body').on('click', '.js_admin-verification-documents', function () {
        modal('#verification-documents', {'photo': $(this).data('photo'), 'passport': $(this).data('passport'), 'message': $(this).data('message'), 'handle': $(this).data('handle'), 'node-id': $(this).data('node-id'), 'request-id': $(this).data('request-id')});
    });
